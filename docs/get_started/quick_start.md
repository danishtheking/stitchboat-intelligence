---
title: Quick Start
description: Get started with Stitchboat Intelligence in just a few minutes!
icon: rocket
---

This guide will walk you through building your first multi-agent workforce using Stitchboat Intelligence.
...
- **Windows:** `C:\Users\[YourUsername]\stitchboat\[YourEmailPrefix]\task_[TaskID]`
- **Mac:** `/Users/[YourUsername]/stitchboat/[YourEmailPrefix]/task_[TaskID]`
...
Stitchboat Intelligence comes with four ready-to-work agents. Each is equipped with a specific set of tools and shines at specific tasks—click to explore:
...
Type your task in the top Message Box. Be as descriptive as you like. For example, ask Stitchboat Intelligence to conduct an UK healthcare market research . You can attach files (like docs, data, images) by clicking the **paperclip icon** in the Message Box.Then, hit **Send**.
...
Once you're happy with the plan, hit **Start Task.** Stitchboat Intelligence will automatically assign each subtask to the best agent for the job based on the tools they have.
...
Stitchboat Intelligence can run in two modes. Your choice here affects how you are billed and what models are available.
