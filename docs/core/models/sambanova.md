---
title: SambaNova
description: This guide walks you through setting up your SambaNova API key within Stitchboat Intelligence to enable the SambaNova model for your AI workforce.
---
...
- Once saved, the **"Set as Default"** button on the SambaNova card will be
  selected/active.
- **You are ready to go.** Your Stitchboat Intelligence agents can now utilize the SambaNova
  model.
