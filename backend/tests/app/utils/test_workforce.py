...
@pytest.mark.unit
def test_stitchboat_make_sub_tasks_success():
    """Test stitchboat_make_sub_tasks successfully decomposes task."""
    api_task_id = "test_api_task_123"
    workforce = Workforce(
    ...
    with (
        ...
        result = workforce.stitchboat_make_sub_tasks(task)
...
@pytest.mark.unit
def test_stitchboat_make_sub_tasks_with_streaming_decomposition():
    """Test stitchboat_make_sub_tasks with streaming decomposition result."""
    api_task_id = "test_api_task_123"
    workforce = Workforce(
        api_task_id=api_task_id, description="Test workforce"
    )
...
@pytest.mark.unit
def test_stitchboat_make_sub_tasks_invalid_content():
    """Test stitchboat_make_sub_tasks with invalid task content."""
    api_task_id = "test_api_task_123"
    workforce = Workforce(
        api_task_id=api_task_id, description="Test workforce"
    )
    ...
    with patch(
        ...
        with pytest.raises(UserException):
            workforce.stitchboat_make_sub_tasks(task)
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_stitchboat_start_success():
    """Test stitchboat_start successfully starts workforce."""
    api_task_id = "test_api_task_123"
    workforce = Workforce(
        api_task_id=api_task_id, description="Test workforce"
    )
    ...
    with (
        ...
        await workforce.stitchboat_start(subtasks)
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_stitchboat_start_with_exception():
    """Test stitchboat_start handles exceptions properly."""
    api_task_id = "test_api_task_123"
    workforce = Workforce(
        api_task_id=api_task_id, description="Test workforce"
    )
...
@pytest.mark.unit
def test_stitchboat_make_sub_tasks_with_none_task():
    """Test stitchboat_make_sub_tasks with None task."""
    ...
    with pytest.raises((AttributeError, TypeError)):
        workforce.stitchboat_make_sub_tasks(None)


@pytest.mark.unit
def test_stitchboat_make_sub_tasks_with_malformed_task():
    """Test stitchboat_make_sub_tasks with malformed task object."""
    api_task_id = "error_test_123"
    workforce = Workforce(
        api_task_id=api_task_id, description="Error test workforce"
    )
    ...
    with patch(
        ...
        with pytest.raises(UserException):
            workforce.stitchboat_make_sub_tasks(fake_task)


@pytest.mark.unit
@pytest.mark.asyncio
async def test_stitchboat_start_with_empty_subtasks():
    """Test stitchboat_start with empty subtasks list."""
    ...
    with (
        ...
        await workforce.stitchboat_start([])
...
async def test_full_workforce_lifecycle():
    ...
    with (
        ...
        result_subtasks = workforce.stitchboat_make_sub_tasks(main_task)
        assert len(result_subtasks) == 3

        await workforce.stitchboat_start(result_subtasks)
