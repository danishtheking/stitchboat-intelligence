...
DEFAULT_LANGFUSE_TAGS = ["workforce", "camel", "stitchboat"]
LANGFUSE_OTEL_PATH = "/api/public/otel"

# Attribute keys for stitchboat.project namespace
ATTR_PROJECT_ID = "stitchboat.project.id"

# Attribute keys for stitchboat.task namespace
ATTR_TASK_ID = "stitchboat.task.id"
ATTR_TASK_DESCRIPTION = "stitchboat.task.description"
ATTR_TASK_PARENT_ID = "stitchboat.task.parent_id"
ATTR_TASK_TYPE = "stitchboat.task.type"
ATTR_TASK_STATUS = "stitchboat.task.status"
ATTR_TASK_UPDATE_TYPE = "stitchboat.task.update_type"
ATTR_TASK_UPDATE_OLD_VALUE = "stitchboat.task.update.old_value"
ATTR_TASK_UPDATE_NEW_VALUE = "stitchboat.task.update.new_value"
ATTR_TASK_UPDATE_METADATA = "stitchboat.task.update.metadata"
ATTR_TASK_QUEUE_TIME_SECONDS = "stitchboat.task.queue_time_seconds"
ATTR_TASK_PROCESSING_TIME_SECONDS = "stitchboat.task.processing_time_seconds"
ATTR_TASK_QUALITY_SCORE = "stitchboat.task.quality_score"
ATTR_TASK_TIMESTAMP = "stitchboat.task.timestamp"
ATTR_TASK_DEPENDENCIES = "stitchboat.task.dependencies"
ATTR_TASK_SUBTASK_IDS = "stitchboat.task.subtask_ids"

# Attribute keys for stitchboat.worker namespace
ATTR_WORKER_ID = "stitchboat.worker.id"
ATTR_WORKER_TYPE = "stitchboat.worker.type"
ATTR_WORKER_ROLE = "stitchboat.worker.role"
ATTR_WORKER_AGENT = "stitchboat.worker.agent"
ATTR_WORKER_MODEL_TYPE = "stitchboat.worker.model.type"
...
SERVICE_NAME_WORKFORCE = "stitchboat-workforce"
TRACER_NAME_WORKFORCE = "stitchboat.workforce"
    ...
    def log_worker_created(
        ...
        **kwargs,
        ...
        with self.tracer.start_as_current_span(
            ...
            # Stitchboat Intelligence-specific attributes
        ...
        if event.task_id in self.task_spans:
            ...
            if event.token_usage:
                ...
                for key, value in event.token_usage.items():
                    span.set_attribute(f"stitchboat.task.token_usage.{key}", value)
