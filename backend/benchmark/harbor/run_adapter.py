...
from adapter import Stitchboat IntelligenceBenchAdapter
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Convert stitchboat benchmark tasks into Harbor task directories."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=None,
        help=f"Output directory (default: {HARBOR_DATASETS_DIR / 'stitchboat-bench'})",
    )
    parser.add_argument(
        "--benchmark-dir",
        type=Path,
        default=None,
        help="Path to stitchboat benchmark/ directory (default: auto-detect)",
    )
    parser.add_argument(
        "--limit",
        type=int,
    ...
    output_dir = args.output_dir or (HARBOR_DATASETS_DIR / "stitchboat-bench")

    adapter = Stitchboat IntelligenceBenchAdapter(
        task_dir=output_dir,
